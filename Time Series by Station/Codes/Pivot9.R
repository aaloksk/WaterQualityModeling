...
#Import data
df <- read.csv('9.Pivort_10599.csv')
...
fil_df2 <- fil_df2[,c(1,2,3,4,5,8,9,10,11,12,13,16,18)] #Specific tyo nikaaleko
colnames(fil_df2) <- c('Alk','Chloride', 'Days_since_PPT', 'Depth','EColi','Hardness','Nitrite','Nitrogen', 'DO','pH','Phos','SC','Temp') #Rename haaneko
...
ggplot(data = melted_cor, aes(x=Var2, y=Var1, fill=value, label = round(value, 2))) +
  ...
  ggtitle("Correlation Heatmap - Station 10599")

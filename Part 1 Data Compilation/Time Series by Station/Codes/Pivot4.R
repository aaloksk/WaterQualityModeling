...
#Import data
df <- read.csv('4.Pivort_20774.csv')
...
fil_df2 <- fil_df2[,c(1,3,4,8,9,12,13,14,15,17)] #Specific tyo nikaaleko
colnames(fil_df2) <- c('Alk', 'Days_since_PPT', 'Depth', 'DO','pH','TNR','SC','Sulfate','Temp','Turb') #Rename haaneko
...
ggplot(data = melted_cor, aes(x=Var2, y=Var1, fill=value, label = round(value, 2))) +
  ...
  ggtitle("Correlation Heatmap - Station 20774")
